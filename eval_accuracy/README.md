...
Install **[simple-evals](https://github.com/openai/simple-evals)** per the main README ([Prepare](../README.md#prepare)); run GPQA against the k-means server the same way as primary accuracy ([Accuracy (primary)](../README.md#accuracy-primary)). Set `MODEL_PATH` to match the server you calibrate and evaluate.
